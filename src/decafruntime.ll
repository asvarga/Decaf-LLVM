...
@"_V$String" = external global i8*, align 8
...
define %struct.__String* @"_$CreateString"(i8*) local_unnamed_addr #1 {
  %2 = tail call i64 @strlen(i8* %0)
  %3 = add i64 %2, 16
  %4 = tail call i8* @malloc(i64 %3) #9
  %5 = bitcast i8* %4 to %struct.__String*
  %6 = bitcast i8* %4 to i8**
  store i8* bitcast (i8** @"_V$String" to i8*), i8** %6, align 8, !tbaa !3
  %7 = getelementptr inbounds i8, i8* %4, i64 8
  %8 = tail call i64 @llvm.objectsize.i64.p0i8(i8* nonnull %7, i1 false, i1 true, i1 false)
  %9 = tail call i8* @__strcpy_chk(i8* nonnull %7, i8* %0, i64 %8) #8
  ret %struct.__String* %5
}
...
declare i8* @__strcpy_chk(i8*, i8*, i64) local_unnamed_addr #5
...
define i32 @"IO$peek"() local_unnamed_addr #1 {
  %1 = load %struct.__sFILE*, %struct.__sFILE** @__stdinp, align 8, !tbaa !8
  %2 = tail call i32 @getc(%struct.__sFILE* %1)
  %3 = load %struct.__sFILE*, %struct.__sFILE** @__stdinp, align 8, !tbaa !8
  %4 = tail call i32 @ungetc(i32 %2, %struct.__sFILE* %3)
  ret i32 %2
}

; Function Attrs: nofree nounwind
declare i32 @getc(%struct.__sFILE* nocapture) local_unnamed_addr #5

; Function Attrs: nofree nounwind
declare i32 @ungetc(i32, %struct.__sFILE* nocapture) local_unnamed_addr #5
...
; Function Attrs: nofree nounwind
declare i32 @fgetc(%struct.__sFILE* nocapture) local_unnamed_addr #5

; Function Attrs: nounwind ssp uwtable
define i32 @"IO$getInt"() local_unnamed_addr #7 {
...
; Function Attrs: nofree nounwind
declare i32 @scanf(i8* nocapture readonly, ...) local_unnamed_addr #5

; Function Attrs: nounwind ssp uwtable
define %struct.__String* @"IO$getLine"() local_unnamed_addr #7 {
  %1 = alloca [10240 x i8], align 16
  %2 = getelementptr inbounds [10240 x i8], [10240 x i8]* %1, i64 0, i64 0
  call void @llvm.lifetime.start.p0i8(i64 10240, i8* nonnull %2) #8
  %3 = load %struct.__sFILE*, %struct.__sFILE** @__stdinp, align 8, !tbaa !8
  %4 = call i8* @fgets(i8* nonnull %2, i32 10240, %struct.__sFILE* %3)
  %5 = call i64 @strlen(i8* nonnull %2) #8
  %6 = add i64 %5, 16
  %7 = call i8* @malloc(i64 %6) #10
  %8 = bitcast i8* %7 to %struct.__String*
  %9 = bitcast i8* %7 to i8**
  store i8* bitcast (i8** @"_V$String" to i8*), i8** %9, align 8, !tbaa !3
  %10 = getelementptr inbounds i8, i8* %7, i64 8
  %11 = call i64 @llvm.objectsize.i64.p0i8(i8* nonnull %10, i1 false, i1 true, i1 false) #8
  %12 = call i8* @__strcpy_chk(i8* nonnull %10, i8* nonnull %2, i64 %11) #8
  call void @llvm.lifetime.end.p0i8(i64 10240, i8* nonnull %2) #8
  ret %struct.__String* %8
}
...
; Function Attrs: nounwind ssp uwtable
define %struct.__ARRAY* @"_$ArrayAllocate"(i32, i32, ...) local_unnamed_addr #7 {
...
46:                                               ; preds = %46, %43
  ...
  store %struct.__ARRAY* %49, %struct.__ARRAY** %47, align 8, !tbaa !8
...
attributes #7 = { nounwind ssp uwtable "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "less-precise-fpmad"="false" "min-legal-vector-width"="0" "no-frame-pointer-elim"="true" "no-frame-pointer-elim-non-leaf" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="false" "stack-protector-buffer-size"="8" "target-cpu"="penryn" "target-features"="+cx16,+cx8,+fxsr,+mmx,+sahf,+sse,+sse2,+sse3,+sse4.1,+ssse3,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
